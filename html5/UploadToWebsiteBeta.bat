...
wsl rsync -avz --progress -e "ssh" /mnt/d/%PROJECT_PATH%/%APP_NAME%*.* %_FTP_USER_%@%_FTP_SITE_%:www/%WEB_SUB_DIR%/
wsl rsync -avzr --progress -e "ssh" /mnt/d/%PROJECT_PATH%/WebLoaderData %_FTP_USER_%@%_FTP_SITE_%:www/%WEB_SUB_DIR%/
wsl rsync -avz --progress -e "ssh" /mnt/d/%PROJECT_PATH%/index.html %_FTP_USER_%@%_FTP_SITE_%:www/%WEB_SUB_DIR%/
